--Function
local DifNPC = true
local StationaryNPC = game.workspace.ScriptAttachedObjects.NPCS.NPC_1.Button.Red.Position
local debounce = true
...
local list = {"Wild Fire Fact: 90% of California wild fires are Manmade.", "These Manmade wild fires are called Dixie Fires"} 
