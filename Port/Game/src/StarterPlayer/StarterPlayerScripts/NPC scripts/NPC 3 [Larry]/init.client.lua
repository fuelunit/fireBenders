--Function
local DifNPC = true
local StationaryNPC = game.workspace.ScriptAttachedObjects.NPCS.NPC_4.Button.Red.Position
local debounce = true
...
local list = {"Wild Fire Fact: Californias, Dixie Fire is the largest wildfire in its state history.", "It was so bright the smoke and fire could be seen from space."} 
local NPCname = ("FireFighter")
